		...
		if($id === "null"){
			...
			$query = "SELECT * FROM $cat WHERE id = $id";
					...
					echo 
                    	...
                    	'</p>'.
						//link ai servizi SL
						'<a href="AvailableSL.html?cat=' . $cat .'&id='. $id . '" >
							SCOPRI I SERVIZI SMARTLIFE DISPONIBILI PER QUESTO DISPOSITIVO!</a>'.
               			'<br><br><br>'.
						//link alle assistenze
						'<a href="Assistance.html?cat=supportotecnico&id=1">SERVE SUPPORTO TECNICO?</a>'.
						'<br>'.'<br>'.
						'<div id="supporto_img">'.
						'<img src="images/03_Configurazione_0.png">'.'</div>'.
                		'</div>';
